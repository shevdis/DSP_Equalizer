...
public class Equalizer {
    ...
    public void setInputSignal(short[] inputSignal) {
        ...
        this.filters[8].settings(inputSignal, FilterInfo.COFFS_NUM_OF_BAND_8, FilterInfo.COFFS_DEN_OF_BAND_8);
        this.filters[9].settings(inputSignal, FilterInfo.COFFS_NUM_OF_BAND_9, FilterInfo.COFFS_DEN_OF_BAND_9);
